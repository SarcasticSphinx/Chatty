      ...
      <div className="container mx-auto px-4 flex items-center justify-between h-16">
        ...
        <div className="hidden lg:flex items-center justify-between gap-4">
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="dropdown-content menu menu-sm p-2 shadow-lg bg-base-200 rounded-box w-52 z-[99 99]"
            >
              <li>
                <button
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="lg:hidden absolute top-16 right-4 bg-base-200 shadow-lg p-4 rounded-lg w-48 z-[1099]"
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <div className="dropdown dropdown-end w-full">
                  ...
                  <ul
                    tabIndex={0}
                    className="dropdown-content menu menu-sm p-2 shadow-lg bg-base-200 rounded-box w-52 z-[1099]"
                  >
                    <li>
                      <button
                        onClick={() => toggleTheme("light")}
